...
(adsbygoogle = window.adsbygoogle || []).push({});
    ...
    <div class="row">
		  <div class="col-sm-6">
			   <p class="text-muted">Catatan: jika sudah membayar, silakan klik konfirmasi maka saldo anda akan bertambah otomatis setelah di cek admin.
			   <br>
			   	untuk yang melakukan pengisian pulsa/bukan transfer pulsa harap konfirmasi melalui sms.
			   </p>
			  ...
			  <?php if (validation_errors()) : ?>
			   ...
			   <?= form_open() ?>
					...
					<div class="form-group">
						...
						<input type="number" name="jumlah" class="form-control" id="jumlah" value="10000"/>
						<small class="text-muted">Jumlah deposit minimal 10000</small>
					</div>
					<div class="form-group">
